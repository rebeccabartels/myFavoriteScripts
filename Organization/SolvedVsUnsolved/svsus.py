...
"""
Renames all unorganized assignment/HW folders to either 'SOLVED' or 'UNSOLVED'

The problem is without a standard, readable folder structure, the course material can't be automated against

Adding solved assignments to student repo and such should be automated on a cronjob

The lesson plans need a suitable standard structure
"""
...
REPO_DIR = os.path.join(HOMEPATH, 'projects/trilogy_TA_class/lesson-plans/01-Class-Content')
