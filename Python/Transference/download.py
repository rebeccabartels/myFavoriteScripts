...
# mykey = paramiko.RSAKey.from_private_key_file('~/My-ssh.priv')  # This is when password less login is setup
  password = 8gHivv5!0#RQLVI6271Bqd         # This is used when password is used to login      
  host = mchdttls3cp0h470646g83h4h930.ftp.marketingcloudops.com
  username = 514001328_2
  port = 22
